...
<html>
    ...
    <body>
        ...
        <form action="all-product" method="get" name="frGate" class="mt-5 mb-5">
                                        ...
                                        <div class="card-body">
                                            <div class="list-menu">
                                                <c:forEach var="category" items="${requestScope.categories}">
                                                    <c:if test="${category.catId eq requestScope.category}">
                                                        <input type="radio" name="category" value="${category.catId}" checked /> 
                                                        ${category.catName} <br/>



                                                    </c:if>
                                                    <c:if test="${category.catId != requestScope.category}">

                                                        <input type="radio" name="category" value="${category.catId}"/> 
                                                        ${category.catName}<br/>
                                        ...
                                        <div class="col-md-4">
                                            <figure class="card card-product-grid" style="width: 250px; height: 400px">
                                                <div class="img-wrap" > 
                                                    ...
                                                    <a href="product-detail?productid=${requestScope.listP.get(i).proId}">
                                                ...
                                                <figcaption class="info-wrap">
                                                    <div class="fix-height">
                                                        <div id="productnamefix">
                                                            <a href="product-detail?productid=${requestScope.listP.get(i).proId}" class="title">${requestScope.listP.get(i).proName}</a>
                                                        </div>

                                                        <div class="price-wrap mt-2" style="padding-top: 5px">
                                                            <span class="price">$${requestScope.listP.get(i).proPrice}</span>
                                ...
                                <nav class="mt-4" aria-label="Page navigation sample">
                                    <ul class="pagination">
                                        ...
                                        <c:if test="${pageCurrent ==1}">
                                            ...
                                            <c:if test="${pageCurrent !=1}">
                                            <li class="page-item"><a class="page-link" href="all-product?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=1&sort=${requestScope.sortabc}&search=${requestScope.searchname}">First</a></li>
                                            </c:if>
                                        ...
                                        <c:forEach var="page" begin="${beginPage}" end="${endPage}">
                                            <c:if test="${pageCurrent == page}">
                                                ...
                                                <c:if test="${pageCurrent != page}">
                                                <li class="page-item"><a class="page-link" href="all-product?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=${page}&sort=${requestScope.sortabc}&search=${requestScope.searchname}">${page}</a></li>
                                                </c:if>
                                            </c:forEach>
                                        ...
                                        <c:if test="${pageCurrent ==numberPage}">
                                            ...
                                            <c:if test="${pageCurrent !=numberPage}">
                                            <li class="page-item"><a class="page-link" href="all-product?category=${requestScope.category}&beginp=${beginprice}&endp=${endprice}&page=${numberPage}&sort=${requestScope.sortabc}&search=${requestScope.searchname}">Last</a></li>
                                            </c:if>
                                    </ul>
                                </nav>
                            </c:if>
